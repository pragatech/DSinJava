...
import com.praga.list.doubly.linked.CircularDoublyLinkedList;
...
public class CircularDoublyLinkedListTest {
	public static void main(String[] args) {
		...
		System.out.println("====Insertion Circular Doubly-Linked List====");
		...
		list.insertAt(6, 6);
		list.traverse();
		System.out.println("\n====Circular Doubly-Linked List - reverse Order====");
